setwd("E:/pruebas laboratorio")
inputpaths1<-"E:/pruebas laboratorio/"
inputpaths2<- c("prueba2_50/","prueba2_60/","prueba2_70/","prueba2_80/",
                "prueba2_90/","prueba2_100/")
inputpath<-paste0(inputpaths1,inputpaths2)

resistencia_50<-c(50,80,105,160,250,350,
                  500,800,1300,3000,8000)

resistencia_60<-c(10,30,50,80,120,180,250,350,
                  500,700,1000,2000,5500,8000)

resistencia_70<-c(5,10,20,40,70,100,150,250,350,
                  500,700,1000,2000,5000,8000)

resistencia_80<-c(10,25,50,75,100,150,200,250,
                  350,500,700,1000,2000,7000)

resistencia_90<-c(5,10,20,40,60,90,120,150,200,
                  250,300,400,500,750,1000,1500,3000,7000)

resistencia_100<- c(1,5,20,30,40,60,80,
                    110,150,200,400,800,1500,3000,7000)
...
inputpaths_viento<- c("prueba_50/","prueba_60/","prueba_70/","prueba_80/",
                      "prueba_90/","prueba_100/")

v_viento<-list()
for (i  in 1:6) {
  
  setwd(paste0("E:/pruebaslaboratorio/",inputpaths_viento[i]))
